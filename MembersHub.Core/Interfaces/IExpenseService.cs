...
public interface IExpenseService
{
    ...
    Task<Dictionary<ExpenseCategory, decimal>> GetExpensesByCategoryAsync(DateTime startDate, DateTime endDate);
    ...
    Task<List<(ExpenseCategory Category, decimal Amount, int Count)>> GetExpenseCategoryStatsAsync(DateTime startDate, DateTime endDate);
